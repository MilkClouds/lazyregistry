...
class PretrainedMixin(Generic[ConfigT]):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_path: str | Path, **kwargs: Any) -> "PretrainedMixin":
        """
...
class AutoRegistry(Generic[ModelT]):
    ...
    def __init__(self) -> None:
        ...
        raise TypeError(
            f"{self.__class__.__name__} is designed to be used as a static class "
    ...
    @classmethod
    def from_pretrained(cls, pretrained_path: str | Path, **kwargs: Any) -> ModelT:
        """
        Load a model from a saved configuration.
